...
create policy "Users can view their own text_responses"
...
create policy "Users can insert their own text_responses"
...
create policy "Users can update their own text_responses"
...
create policy "Users can delete their own text_responses"
...
create policy "Users can view their own qualitative_scores"
...
create policy "Users can insert their own qualitative_scores"
...
create policy "Users can update their own qualitative_scores"
...
create policy "Users can delete their own qualitative_scores"
